  ...
  return (
    <>
      ...
      <p className="AboutDescription">
        Jared is a Fifth-Semester Junior majoring in Computer Science. He is the
        project leader.
      </p>
      ...
      <p className="AboutDescription">
        Luke is a Fifth-Semester Junior majoring in Computer Science. He's hard
        at work on the CLI tool!
      </p>
